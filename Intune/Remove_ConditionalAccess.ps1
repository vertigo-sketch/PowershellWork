...
$Path = "C:\Temp\RemoveConditional.csv"
...
ForEach ($User in $Users){     
  ...
  $ID = Get-MgUser -UserId $User.UserPrincipalName | select Id
  #Get-MgUser -UserId $User.UserPrincipalName | Select-Object Id

  #Removes users to Intune Conditional Access MFA Exception
 Remove-MgGroupMemberByRef -GroupId 'c3e7f7ca-559a-4d2b-8a9c-db5491c3d14e' -DirectoryObjectId $ID.Id
